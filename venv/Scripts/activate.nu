...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Mykhailo\Desktop\Python\NumGuesser\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Mykhailo\Desktop\Python\NumGuesser\venv\Scripts\deactivate.nu'
